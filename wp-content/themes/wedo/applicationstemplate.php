                    ...
                    <div class="grid_3">
                        <div class="sidebar-top">
                            <div class="sidebar-widget">
                                ...
                                <ul class="">
                                    <li style="font-size:14px;"><a href="<?php formaturlwithlanguage('?page_id=37');?>"><img src="<?php bloginfo('template_url')?>/images/content/icons/Workflow.png" /><?php _e("Workflow","wedo"); ?></a></li>
